...
class CustomPopoverViewController: NSViewController {
    ...
    override func loadView() {
        ...
        pinButton.image = NSImage(
            systemSymbolName: "pin", accessibilityDescription: "Pin")
        pinButton.alternateImage = NSImage(
            systemSymbolName: "pin.fill", accessibilityDescription: "Unpin")
        ...
        NSLayoutConstraint.activate([
            ...
            pinButton.topAnchor.constraint(
        ...
        self.appearanceObserver = NSApp.observe(\.effectiveAppearance) {
            [weak self] _, _ in
            ...
            .performAsCurrentDrawingAppearance {
                if #available(macOS 10.14, *) {
                    view.layer?.backgroundColor =
                        NSColor(named: NSColor.Name("windowBackgroundColor"))?
                        .cgColor
    ...
    func updateMessage(_ message: String) {
        ...
        let attributedString = NSAttributedString(
            string: message, attributes: [.font: messageLabel.font!])
